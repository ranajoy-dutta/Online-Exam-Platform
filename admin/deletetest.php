...
echo "<br><h2><div  class=head1>Delete Test</div></h2>";
if($_POST[submit]=='Save' || strlen($_POST['subid'])>0 )
{
extract($_POST);
mysql_query("delete from mst_test where sub_id='$subid' AND test_name='$testname'",$cn) or die(mysql_error());
echo "<p align=center>Test <b>\"$testname\"</b> Delete Successfully.</p>";
unset($_POST);
